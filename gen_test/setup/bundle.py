...
class GenTestBundle:
    '''
        GenTest bundle holding the components of gen_test.
        ...
        It defines:
            ...
            :methods:
                | to_dict - Converts the gen_test bundle to a dictionary.
    '''
    ...
    def to_dict(self) -> dict[str, object]:
        '''
            Converts the gen_test bundle to a dictionary.

            :return: Dictionary representation of the gen_test bundle.
            :exceptions: None.
        '''
