...
Info
    A validator for the gen_test bundle.
'''
...
class GenTestBundleValidator:
    '''
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_test bundle.
                | is_valid - Checks if the gen_test bundle is valid.
    '''

    @classmethod
    def validate(cls, bundle: GenTestBundle) -> None:
        '''
            Validates the gen_test bundle.

            :param bundle: The gen_test bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_test_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_test bundle must be provided'
        msg_bundle_istype: str = 'the gen_test bundle must be an instance of GenTestBundle'
        ...
        istype(bundle, GenTestBundle, ctx, msg_bundle_istype)
    ...
    @classmethod
    def is_valid(cls, bundle: GenTestBundle) -> bool:
        '''
            Checks if the gen_test bundle is valid.

            :param bundle: The gen_test bundle to be checked.
