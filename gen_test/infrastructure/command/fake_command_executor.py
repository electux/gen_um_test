...
Info
    Defines FakeCommandExecutor class.
'''
...
class FakeCommandExecutor:
    '''
        Command executor strategy for generating in-memory Fake stub header.
    ...
    def __init__(self, definition: ICommandDefinition) -> None:
        '''
            Initializes FakeCommandExecutor.
    ...
    def execute(self, *, params: Mapping[str, object], service: IService) -> Mapping[str, object]:
        ...
        res = service.generate_fake(config)
        return {
