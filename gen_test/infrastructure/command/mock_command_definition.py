...
Info
    Defines MockCommandDefinition class.
'''
...
class MockCommandDefinition:
    '''
        CLI subcommand metadata definition for generating GoogleMock header.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate GoogleMock C++ header for interface'
    ...
    def options(self) -> Sequence[OptionData]:
        ...
        return [
            ...
            OptionData(
                name='--output',
                help_text='Output directory for generated mock header',
                action=None,
                default='./tests',
                required=False,
                choices=None,
            ...
            OptionData(
                name='--name',
                help_text='Specific interface name if file contains multiple',
                action=None,
                default=None,
                required=False,
                choices=None,
