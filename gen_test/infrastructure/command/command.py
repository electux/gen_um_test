...
Info
    Defines CommandBundle dataclass combining command definition and executor.
'''
...
from gen_test.infrastructure.command.icommand_executor import ICommandExecutor
...
class CommandBundle:
    '''
        ...
        :param definition: The command CLI metadata definition.
        :param executor: The command execution strategy.
    '''
