...
Info
    Defines CMakeCommandExecutor class.
'''
...
class CMakeCommandExecutor:
    '''
        Command executor strategy for generating CMakeLists.txt.
    ...
    def __init__(self, definition: ICommandDefinition) -> None:
        '''
            Initializes CMakeCommandExecutor.
    ...
    def execute(self, *, params: Mapping[str, object], service: IService) -> Mapping[str, object]:
        ...
        res = service.generate_cmake(config)
        return {
