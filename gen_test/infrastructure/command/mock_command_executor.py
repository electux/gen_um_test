...
Info
    Defines MockCommandExecutor class.
'''
...
class MockCommandExecutor:
    '''
        Command executor strategy for generating GoogleMock header.
    ...
    def __init__(self, definition: ICommandDefinition) -> None:
        '''
            Initializes MockCommandExecutor.
    ...
    def execute(self, *, params: Mapping[str, object], service: IService) -> Mapping[str, object]:
        ...
        res = service.generate_mock(config)
        return {
