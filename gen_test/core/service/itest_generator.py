...
Info
    Defines abstract interface for GoogleTest synthesizer.
'''
...
class ITestGenerator(Protocol):
    '''
        ...
        It defines:
            ...
            :methods:
                | generate - Synthesizes GoogleTest C++ unit test code.
                | is_initialized - Checks if generator is initialized.
    '''

    def generate(self, interface: CppInterface, mock_header_name: str) -> str:
        '''
            Synthesizes GoogleTest unit test code.

            :param interface: Parsed CppInterface model.
            :param mock_header_name: Filename of the generated mock header.
            :return: Generated C++ unit test code.
            :exceptions: None.
        '''
