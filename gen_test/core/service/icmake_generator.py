...
Info
    Defines abstract interface for CMakeLists.txt synthesizer.
'''
...
@runtime_checkable
class ICMakeGenerator(Protocol):
    '''
        Defines abstract interface for CMakeLists.txt synthesizer.
        ...
        It defines:
            ...
            :methods:
                | generate - Synthesizes CMakeLists.txt build code.
    ...
    def generate(
        ...
        '''
            ...
            :param sources: Tuple of source file names (e.g. ("test.cc", "test_main.cc")).
