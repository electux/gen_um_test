...
Info
    Main entry point for gen_um_test CLI tool.
'''
...
def main() -> bool:
    '''
        Bootstraps and runs gen_um_test with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None.
    '''
    gen_um_test: GenUmTest = GenUmTest(GenUmTestBundleFactory.create_bundle())
    return gen_um_test.process()


if __name__ == '__main__':
    '''
        Entry point for gen_um_test execution.
