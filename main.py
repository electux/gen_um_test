...
Info
    Main entry point for gen_test CLI tool.
'''
...
def main() -> bool:
    '''
        Bootstraps and runs gen_test with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None.
    '''
    gen_test: GenTest = GenTest(GenTestBundleFactory.create_bundle())
    return gen_test.process()


if __name__ == '__main__':
    '''
        Entry point for gen_test execution.
