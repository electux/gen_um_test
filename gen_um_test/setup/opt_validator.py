...
Info
    Validator for the gen_um_test bundle options.
'''
...
class GenUmTestBundleOptionsValidator:
    '''
        Validator for the gen_um_test bundle options.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_um_test bundle options.
                | is_valid - Checks if the gen_um_test bundle options is valid.
    '''

    @classmethod
    def validate(cls, options: GenUmTestBundleOptions) -> None:
        '''
            Validates the gen_um_test bundle options.

            :param options: The gen_um_test bundle options to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_um_test_bundle_options_validator::validate(...)'
        msg_options_none: str = 'the gen_um_test bundle options must be provided'
        msg_options_istype: str = 'the gen_um_test bundle options must be a Mapping'

        not_none(options, ctx, msg_options_none)
        istype(options, Mapping, ctx, msg_options_istype)

        for attr_name, expected_type in GenUmTestBundleKeys.get_option_to_type().items():
    ...
    @classmethod
    def is_valid(cls, options: GenUmTestBundleOptions) -> bool:
        '''
            Checks if the gen_um_test bundle options is valid.

            :param options: The gen_um_test bundle options to be checked.
