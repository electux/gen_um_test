...
Info
    A validator for the gen_um_test bundle.
'''
...
class GenUmTestBundleValidator:
    '''
        A validator for the gen_um_test bundle.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_um_test bundle.
                | is_valid - Checks if the gen_um_test bundle is valid.
    '''

    @classmethod
    def validate(cls, bundle: GenUmTestBundle) -> None:
        '''
            Validates the gen_um_test bundle.

            :param bundle: The gen_um_test bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_um_test_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_um_test bundle must be provided'
        msg_bundle_istype: str = 'the gen_um_test bundle must be an instance of GenUmTestBundle'
        ...
        istype(bundle, GenUmTestBundle, ctx, msg_bundle_istype)
    ...
    @classmethod
    def is_valid(cls, bundle: GenUmTestBundle) -> bool:
        '''
            Checks if the gen_um_test bundle is valid.

            :param bundle: The gen_um_test bundle to be checked.
