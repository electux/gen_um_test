...
Info
    Defines CMakeCommandDefinition class.
'''
...
class CMakeCommandDefinition:
    '''
        CLI subcommand metadata definition for generating CMakeLists.txt.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate CMakeLists.txt build file for interface tests'
    ...
    def options(self) -> Sequence[OptionData]:
        ...
        return [
            ...
            OptionData(
                name='--output',
                help_text='Output directory for generated CMakeLists.txt',
                action=None,
                default='./tests',
                required=False,
                choices=None,
