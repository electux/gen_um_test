...
Info
    Defines FakeCommandDefinition class.
'''
...
class FakeCommandDefinition:
    '''
        CLI subcommand metadata definition for generating in-memory Fake stub header.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate in-memory Fake stub C++ header for interface'
    ...
    def options(self) -> Sequence[OptionData]:
        ...
        return [
            ...
            OptionData(
                name='--output',
                help_text='Output directory for generated fake header',
                action=None,
                default='./tests',
                required=False,
                choices=None,
